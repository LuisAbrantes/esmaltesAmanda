...
- [x] `T017` Conectar camada live do Supabase no app
      Status: `done`
      Owner: `Codex`
      Dependencias: `T006`, `T007`, `T008`
      Definicao de pronto: auth simplificado com email direto, leitura/escrita e fotos passando pelo projeto Supabase real, com validacao em build e teste manual
